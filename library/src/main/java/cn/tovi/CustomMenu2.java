...
/**
 * Test XML inside view
 */
public class CustomMenu2 extends RelativeLayout {

    private static final String TAG = CustomMenu2.class.getSimpleName();
...
//    private ImageView rightMask;
    ...
    public CustomMenu2(Context context) {
        this(context, null);
    }

    public CustomMenu2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomMenu2(Context context, AttributeSet attrs, int defStyleAttr) {
